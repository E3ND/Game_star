...
<head>
    ...
    <link rel="short icon" href="<?= $BASE_URL ?>img/gamestar.png" />
    ...
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg">
            <a href="<?= $BASE_URL ?>" class="navbar-brand">
                <img src="<?= $BASE_URL ?>img/gamestar.png" alt="GameStar" id="logo">
            ...
            <form action="" method="GET" id="search-form" class="form-inline my-2 my-lg-0">
                <input type="text" name="q" id="search" class="form-control mr-sm-2" type="search" placeholder="Buscar Jogos" aria-lable="Search">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="<?= $BASE_URL ?>ediprofile.php" class="nav-link bold">
                            <?= $userData->name ?>
                        </a>
                    </li>
